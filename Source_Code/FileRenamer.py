...
class FileRenamer:
    ...
    def rename_files(self, first_file_index, verbose):
        ...
        for image in os.listdir(self.input_directory):
            ...
            self.fileManager.save_image_nokeyword("Source_Code//RENAMER//RENAMED_FILES", loaded_image, index=first_file_index)
            first_file_index += 1
            if verbose:
...
if __name__ == '__main__':
    fileRenamer = FileRenamer("Source_Code//RENAMER//FILES_TO_RENAME", "Source_Code//RENAMER//RENAMED_FILES")
    fileRenamer.rename_files(349, verbose=True)
